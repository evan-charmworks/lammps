...
void FixPhonon::readmap()
{
  ...
  r_token = line;
  nx     = utils::inumeric(FLERR, utils::strtok_r(r_token, " \n\t\r\f",&r_token),false,lmp);
  ny     = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
  nz     = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
  nucell = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
  ntotal = nx*ny*nz;
  ...
  for (int i = 0; i < ngroup; ++i){
    ...
    r_token = line;
    ix   = utils::inumeric(FLERR, utils::strtok_r(r_token, " \n\t\r\f",&r_token),false,lmp);
    iy   = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
    iz   = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
    iu   = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
    itag = utils::inumeric(FLERR, utils::strtok_r(nullptr, " \n\t\r\f",&r_token),false,lmp);
